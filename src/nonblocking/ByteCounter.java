...
public class ByteCounter extends HttpServlet {
    ...
    /**
     * Keep in mind that each getInfo2 may well be on a different thread to the
     * previous getInfo2. Ensure that changes in values will be visible across
    ...
    private static class CounterListener implements ReadListener, WriteListener {
        ...
        public void onAllDataRead() throws IOException {
            ...
            // If sos is not ready to write data, the getInfo2 to isReady() will
            // register the socket with the poller which will trigger a getInfo2 to
